...
SINE_REFERENCE_PERIOD = 1
SINE_REFERENCE_AMPLITUDE = 50
SIGMOID_REFERENCE_AMPLITUDE = 50
SIGMOID_REFERENCE_PERIOD = 0.3
SIGMOID_REFERENCE_SLOPE = 15
...
# --- ACADOS MPC Parameters ---
ACADOS_MPC_HORIZON = 20 # Original: 20
ACADOS_MPC_QH = 50 # Original: 100
ACADOS_MPC_QV = 20 # Original: 20
ACADOS_MPC_R = 0.001 # Original: 0.05
ACADOS_MPC_TERMINAL = 10
ACADOS_MPC_DELTA_U_MAX = 15 # Original: 15

# --- Stochastic MPC Parameters ---
STOCHASTIC_MPC_HORIZON = 20
STOCHASTIC_MPC_SAMPLES = 5
STOCHASTIC_MPC_QH = 100
STOCHASTIC_MPC_QV = 20
STOCHASTIC_MPC_R = 0.05
STOCHASTIC_MPC_TERMINAL = 10
STOCHASTIC_MPC_DELTA_U_MAX = 15
STOCHASTIC_MPC_NOISE_STD = 0.2
...
TUBE_MPC_TIGHTING_X = 10
TUBE_MPC_TIGHTING_U = 10
TUBE_MPC_LQR_SCALE = 0.5